...
if (-not (Test-Path -LiteralPath '.env')) {
    ...
    Write-Host 'Generated .env. Your admin password is stored there; keep this file private.'
}
...
Write-Host "Ready: http://localhost:$actualPort (username admin; password in .env)"
